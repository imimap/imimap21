          ...
          >
            <template #payment>
                <select class="form-control form-select mx-2 my-2 w-auto h-auto"
                        ...
                        id="search_paid"
                >
                  <option value="">{{ $t("search.form.paymentOptions.standard") }}</option>
                  <option value="true">{{ $t("search.form.paymentOptions.paid") }}</option>
                  <option value="false">{{ $t("search.form.paymentOptions.unpaid") }}</option>
                </select>
            </template>
            <template #location>
                ...
                <select class="form-control form-select mx-2 my-2 w-auto h-auto"
                        ...
                        id="search_location"
                >
                  <option value="">{{ $t("search.form.niceLocation") }}</option>
                  ...
                  <option value="El Salto Granadilla Teneriffa">
                    El Salto Granadilla Teneriffa
                  </option>
                  ...
                  <option value="Minas Gerais - Belo Horizonte">
            ...
            <template #orientation>
              ...
              >
                <option value="">{{ $t("search.form.fun") }}</option>
            ...
            <template #programmingLanguage>
              ...
              >
                <option value="">{{ $t("search.form.interested") }}</option>
